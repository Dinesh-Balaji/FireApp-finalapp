...
public class WorkSpaceComment extends AppCompatActivity {
SharedPreferences sp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_space_comment);

        button = (Button) findViewById(R.id.addcomid1);
   ...
   public void openfacaddcom(){
        Intent intent=new Intent(this, review.class);
        intent.putExtra("val",Integer.parseInt(val));
