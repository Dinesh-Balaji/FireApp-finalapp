...
public class WorkSpaceStudent extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_space_student);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.logout){
            ...
            Intent myintent = new Intent(WorkSpaceStudent.this, HomeActivity.class);
    ...
    public void onClick(View view)
    {
        if(view.getId()==b1.getId())
        {
            ...
            edit.commit();
            startActivity(new Intent(getApplicationContext(), WorkSpaceComment.class));
        }
    ...
    public void onBackPressed()
    {
        if (doubleBackToExitPressedOnce) {
            super.onBackPressed();
            Intent start = new Intent(WorkSpaceStudent.this, HomeActivity.class);
            startActivity(start);
            Toast.makeText(this, "Logged Out Successfully", Toast.LENGTH_SHORT).show();
            return;
        }
